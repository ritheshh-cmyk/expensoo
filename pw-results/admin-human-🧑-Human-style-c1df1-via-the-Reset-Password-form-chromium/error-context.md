...
- Name: admin-human.spec.ts >> 🧑 Human-style E2E — Admin Full Journey >> Step 6 — Admin resets password via the Reset Password form
- Location: e2e\admin-human.spec.ts:215:3
...
- main:
  ...
  - table:
    ...
    - rowgroup:
      - row "5/31/2026, 7:59:41 PM LOGIN admin — ::1 Success Successful login":
        - cell "5/31/2026, 7:59:41 PM"
        - cell "LOGIN"
        - cell "admin"
        - cell "—"
        - cell "::1"
  ...
  - button "Revoke session":
    - img
  - paragraph: 24 active sessions • Sessions auto-expire after 24 hours of inactivity
