...
- Name: admin-human.spec.ts >> 🧑 Human-style E2E — Admin Full Journey >> Step 7 — Verify reset user logs in with new password (browser login)
- Location: e2e\admin-human.spec.ts:255:3
